...
//           // Points to your View-Video endpoint for browser playback
//           setProcessedVideoUrl(`http://localhost:8000/view-video?t=${timestamp}`);
...
//     } catch (err) {
//       setError("Analysis failed. Connection to core lost.");
//       setIsProcessing(false);
//     }
//   };
...
//                         className="w-full flex items-center justify-between px-4 py-3 bg-[#161b2e] border border-cyan-500/30 text-cyan-400 rounded hover:bg-cyan-500 hover:text-black transition-all group"
//                        >
...
//                         className="w-full flex items-center justify-between px-4 py-3 bg-[#161b2e] border border-purple-500/30 text-purple-400 rounded hover:bg-purple-500 hover:text-white transition-all"
//                        >
//                          <span className="text-[10px] font-black uppercase tracking-widest">Save Render</span>
//                          <Download size={14} />
//                        </button>
...
//                      {processedVideoUrl ? 'Live_Output' : isProcessing ? 'Processing' : 'Standby'}
//                    </div>
//                  </div>

//                  <div className="w-full h-full flex items-center justify-center">
//                    {processedVideoUrl ? (
//                      <video key={processedVideoUrl} src={processedVideoUrl} controls autoPlay className="w-full h-full object-contain" />
//                    ) : rawVideoUrl ? (
//                      <video key={rawVideoUrl} src={rawVideoUrl} controls autoPlay className={`w-full h-full object-contain ${isProcessing ? 'brightness-125 contrast-125' : 'opacity-40 grayscale'}`} />
//                    ) : (
...
//                   <span className="text-[8px] font-black uppercase tracking-[0.3em] text-slate-500 mb-1">{m.label}</span>
